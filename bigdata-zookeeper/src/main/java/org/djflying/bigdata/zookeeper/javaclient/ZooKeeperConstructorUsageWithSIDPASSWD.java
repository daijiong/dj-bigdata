...
public class ZooKeeperConstructorUsageWithSIDPASSWD implements Watcher {
    ...
    public static void main(String[] args) throws Exception {
        ...
        zookeeper = new ZooKeeper(Constants.connectString, Constants.sessionTimeout, new ZooKeeperConstructorUsageWithSIDPASSWD(), 1L, "test".getBytes());
        //Use correct sessionId and sessionPassWd
        zookeeper = new ZooKeeper(Constants.connectString, Constants.sessionTimeout, new ZooKeeperConstructorUsageWithSIDPASSWD(), sessionId, passwd);
