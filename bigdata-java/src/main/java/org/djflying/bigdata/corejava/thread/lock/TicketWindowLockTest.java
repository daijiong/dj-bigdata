...
/**
 * 使用ReentrantLock类的lock()方法实现火车票销售系统
 *
 * @author dj4817
 * @version $Id: TicketWindowLockTest.java, v 0.1 2017/11/28 12:51 dj4817 Exp $$
 */
public class TicketWindowLockTest implements Runnable {
     ...
     * @param tickets
     */
    public TicketWindowLockTest(int tickets) {
    ...
    public static void main(String[] args) {
        ...
        TicketWindowLockTest ticketWindowLockTest = new TicketWindowLockTest(10);
